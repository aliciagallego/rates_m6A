...
######################################
## Normalize H1 Cao et al. 2013 data #
######################################
# data from: https://doi.org/10.1371/journal.pgen.1003417

# This script normalizes H1c and H1d histone data (from Cao et al. 2013) by total read number
# and computes normalized levels by quantile elongation rate catgories (slow, medium and fast)
# Boxplots are computed each elongation rate category and histone type (H1c and H1d)
