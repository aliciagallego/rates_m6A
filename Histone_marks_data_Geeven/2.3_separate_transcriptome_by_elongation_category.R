...
write.table(transcriptome_WTslow, 
            file = paste0(output,"RefSeq_20621_Transcriptome_WT_slow.bed"),
            quote = F, 
            sep="\t", 
            col.names = T, 
            row.names = F)
...
write.table(transcriptome_WTmed, 
            file = paste0(output,"RefSeq_20621_Transcriptome_WT_med.bed"),
            quote = F, 
            sep="\t", 
            col.names = T, 
            row.names = F)
...
write.table(transcriptome_WTfast, 
            file = paste0(output,"RefSeq_20621_Transcriptome_WT_fast.bed"),
            quote = F, 
            sep="\t", 
            col.names = T, 
            row.names = F)
...
write.table(transcriptome_TKOslow, 
            file = paste0(output,"RefSeq_20621_Transcriptome_TKO_slow.bed"),
            quote = F, 
            sep="\t", 
            col.names = T, 
            row.names = F)
...
write.table(transcriptome_TKOmed, 
            file = paste0(output,"RefSeq_20621_Transcriptome_TKO_med.bed"),
            quote = F, 
            sep="\t", 
            col.names = T, 
            row.names = F)
...
write.table(transcriptome_TKOfast, 
            file = paste0(output,"RefSeq_20621_Transcriptome_TKO_fast.bed"),
            quote = F, 
            sep="\t", 
            col.names = T, 
            row.names = F)
