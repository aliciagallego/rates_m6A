...
#######################################################################################
## Get promoters coords (TSS±500bp) from RefSeq transcript start/end coords Long List #
#######################################################################################

# This script uses a transcriptome BED list as input and define promoter coordinates as TSS±500bp
