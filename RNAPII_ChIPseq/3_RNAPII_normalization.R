...
####################################
## Normalize RNApolII ChIPseq data #
####################################

# This script normalizes RNAPII ChIP seq data (RNAPII occupancy levels) by total read number per replicate, transcript size (in gene bodies)
# and the normalization factor based on human sequence alignments used as control
