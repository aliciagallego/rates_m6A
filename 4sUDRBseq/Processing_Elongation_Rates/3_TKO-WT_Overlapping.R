...
# This script computes the number of genes that overlap among the three rate categories (slow, medium and fast) between WT and H1-TKO 

# -------
# Paths |
# -------
TTseq_path <- "/path/Elongation_rate_processed.txt"
output <- "/path/Overlaps/"
