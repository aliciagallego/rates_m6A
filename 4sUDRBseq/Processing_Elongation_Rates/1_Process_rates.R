...
#################################
## Process elongation rate data # 
#################################

# This script processes data obtained from elongation rate calculation. In particular it:
# 1. Removes elongation rates from genes that are not represented in all samples
# 2. Transforms elongation rate units into kb/min
# 3. Removes genes with rates equal or below 0.5 kb/min
# 4. Merges gene rates with information from other sequencing experiments (m6A levesl, RNAPII occupancy and pausing, cheRNA expression) 
# 5. Compute quantile division (slow, medium and fast rate genes)
# 6. Compute histograms, density plots, boxplots, and violin plots
